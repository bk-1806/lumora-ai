    ...
    setTimeout(() => {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "Great question! Let me analyze your resume and provide personalized recommendations. I'll look at keyword density, formatting, and content relevance to give you actionable feedback.",
